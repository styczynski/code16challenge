...
n()>.6&&a.push([e,r,[99,184,f]]);q(Y,5,a)}(),J=[];for(let K=0,e=m,i=0<=e;i?K<=e:K>=e;i?K++:K--){let e=r[K];for(let r=e,i=m,h=e<=i;h?r<=i:r>=i;h?r++:r--){J.push
([K,r,[152,f,152]])}}q(0,0,J);for(let t of Array.from(e))null!=t.w&&(t.o=t.w(t)),q(t.x,t.y,t.o),t.x+=t.d,t.a=0,t.b=t.d,null!=t.c?(t.y+=t.c,t.a=t.c):n()>A&&t.y<=3&&t.y>=0 ?n()>.5?
