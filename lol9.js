...
top:${10*o-10}px;"></div>`),document.write(O+"</div>")},d=function(o){let r=~~(n()*h.length);r+=h.length;const c=h[r%=h.length][0],f=h[r][1],i={x:~~(o+2*n()),y:~~(4*n()),d:2,c:0,w(){
...
s,s,s]]];case 1:return t.f=0,[[0,2,[s,s,s]],[1,1,[s,s,s]],[0,0,[s,s,s]]]}}};return e.push(o)},g=function(o){G={x:~~(o+2*n()),y:~~(4*n()),d:1};let c=0;const i=~~(6*n());let s=i,l=0;
const u=[];for(;s>0;){if(c>3){s=0;break}for(let o=0,n=s,e=0<=n;e?o<=n:o>=n;e?o++:o--){const n=i-c,e=o+l,r=t(n*e*.9);u.push([e,n,[f-r,f-r,f-r]])}c++;V=n();let e=0;V>.95&&(e=3),V>.8
...
x(5*t-10)}a((t,o)=>(function(t,o){let e=30,r=144,c=f;const i=1-(t+o+4*u(o*o))/200;return e-=-75*i+5*n(),r-=-75*i+5*n(),c-=-75*i+5*n(),p(t,o,e,r,c)})(t,o)),function(){let
