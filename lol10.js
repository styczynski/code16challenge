t=x=>~~x,n=Math.random,e=[],r=[],c=-20,f=255,s=25,l=t=>Math.pow(Math.abs(t),1.5),u=Math.sin;let h=[[[46,139,87],[46,139,87]],[[238,59,59],[232,232,232]],
...
[1,1,Z],[2,1,Z],[3,1,Z],[2,0,f]]};return e.push(i)},x=function(t){let o={x:~~(t+2*n()),y:~~(4*n()),d:3,f:0,q:~~(50*-n()+73),w(){t=this;s=t.q;switch(t.f){case 0:return t.f=1,[[1,0,[
s,s,s]]];case 1:return t.f=0,[[0,2,[s,s,s]],[1,1,[s,s,s]],[0,0,[s,s,s]]]}}};return e.push(o)},g=function(o){G={x:~~(o+2*n()),y:~~(4*n()),d:1};let c=0;let i=~~(6*n());let s=i,l=0;
let u=[];for(;s>0;){if(c>3){s=0;break}for(let o=0,n=s,e=0<=n;e?o<=n:o>=n;e?o++:o--){let n=i-c,e=o+l,r=t(n*e*.9);u.push([e,n,[f-r,f-r,f-r]])}c++;V=n();let e=0;V>.95&&(e=3),V>.8
&&(e=2),V>.1&&(e=1);let r=0;for(;r<e;)n()>.5?s--:(l++,s--),r++}return G.o=u,e.push(G)},w=function(){if(n()>.97&&d(-10),n()>.99){for(let t=0,o=1+~~(3*n())-1,e=0<=o;e?t<=o:t>=o;e?t++:t--)
x(5*t-10)}a((t,o)=>(function(t,o){let e=30,r=144,c=f;let i=1-(t+o+4*u(o*o))/200;return e-=-75*i+5*n(),r-=-75*i+5*n(),c-=-75*i+5*n(),p(t,o,e,r,c)})(t,o)),function(){let
