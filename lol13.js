t=x=>~~x,n=Math.random,e=[],r=[],T=-75,c=-20,Y=-c,f=255,A=.9,s=25,m=100,P='style="width:',u=Math.sin;let h=[[[46,139,87],[46,139,87]],[[238,59,59],[232,232,232]],
...
return e})(),y=function(){O=`<div id="view"${P}800px;height:200px">`,a((t,o)=>O+=`<div id="${t}x${o}"${P}10px;height:10px;position:absolute;left:${10*t-10}px;
...
n()>.6&&a.push([e,r,[99,184,f]]);q(Y,5,a)}(),function(){J=[];for(let o=0, e=m,i=0<=e;i?o<=e:o>=e;i?o++:o--){let e=r[o];for(let r=e,i=m,h=e<=i;h?r<=i:r>=i;h?r++:r--){J.push
